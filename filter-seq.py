...
parser.add_argument('-seq', type=str, help="FASTA sequence file")

parser.add_argument('-c', type=str, help="character to remove")

parser.add_argument('-output', type=str, help="new output fasta file")
