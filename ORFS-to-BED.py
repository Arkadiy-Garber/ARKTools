...
parser.add_argument('-orfs', type=str, help='FASTA files of ORFs that is created by Prodigal')

parser.add_argument('-out', type=str, help="outfile in BED format")
...
for i in orfs:
    if re.match(r'^>', i):
        ls = i[1:].split(" # ")
        out.write(allButTheLast(ls[0], "_") + "\t" + ls[1] + "\t" + ls[2] + "\n")
out.close()